...
src_ip = "127.0.0.1"
dst_ip = "10.20.30.40" # Change this 
...
ip_proto = 6 #This is because we are doing TCP
...
tcp_urg = 1                    # Urgent
tcp_ece = 1                    # Explicit Congestion Notification Echo
...
message = b'kirwa'                                    # This should be the student's last name per the prompt
